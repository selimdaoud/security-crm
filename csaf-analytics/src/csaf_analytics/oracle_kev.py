    ...
    *,
    ...
    return {
        ...
        "kpis": {
            ...
            "added_last_90_days": sum(
                row["days_since_added"] <= RECENT_WINDOW_DAYS for row in rows
            ),
            "added_last_365_days": sum(
                row["days_since_added"] <= YEAR_WINDOW_DAYS for row in rows
            ),
